...
public class CategoryController {
	...
	public ResponseEntity<?> getCategoryById(HttpSession session) {
		ResponseEntity<?> responseEntity = null;
		if ((String) session.getAttribute("loggedInUserId") != null) {
			List<Category> list =categoryService.getAllCategoryByUserId((String)session.getAttribute("loggedInUserId"));
			responseEntity = new ResponseEntity<List<Category>>(list,HttpStatus.OK);
